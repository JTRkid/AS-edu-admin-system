...
- [4. 数据库设计](#4-数据库设计)
  ...
  - [4.6 成绩表](#46-成绩表)
- [5. API 设计](#5-api-设计)
  - [5.1 认证接口](#51-认证接口auth)
  - [5.2 学生管理接口](#52-学生管理接口authstudents)
  - [5.3 教师管理接口](#53-教师管理接口authteachers)
  - [5.4 课程接口](#54-课程接口courses)
  - [5.5 章接口](#55-章接口courseschapters)
  - [5.6 节接口](#56-节接口coursessections)
  - [5.7 文档接口](#57-文档接口documents)
  - [5.8 题目接口](#58-题目接口questions)
  - [5.9 提交接口](#59-提交接口submissions)
  - [5.10 成绩接口](#510-成绩接口scores)
  - [5.11 WebSocket](#511-websocket)
  - [5.12 评分机 API](#512-评分机-api)
- [6. 前端路由结构](#6-前端路由结构)
- [7. 部署说明](#7-部署说明)
  - [7.1 环境要求](#71-环境要求)
  - [7.2 后端部署](#72-后端部署)
