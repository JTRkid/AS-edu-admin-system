...
- [零、服务器环境安装](#零服务器环境安装)
  - [0.1 更新系统包](#01-更新系统包)
  - [0.2 安装 Python 3.10+](#02-安装-python-310)
  - [0.3 安装 Node.js 20+](#03-安装-nodejs-20)
  - [0.4 安装 MySQL 8.0+](#04-安装-mysql-80)
  - [0.5 安装 Redis](#05-安装-redis)
  - [0.6 安装 Nginx](#06-安装-nginx)
  - [0.7 安装 Git](#07-安装-git)
  - [0.8 环境安装完成确认](#08-环境安装完成确认)
- [一、从 GitHub 拉取代码](#一从-github-拉取代码)
- [二、后端部署](#二后端部署)
  - [2.1 安装 Python 依赖](#21-安装-python-依赖)
  - [2.2 创建生产环境配置文件](#22-创建生产环境配置文件)
  - [2.3 修改 settings.py 读取 .env](#23-修改-settingspy-读取-env)
  - [2.4 创建数据库](#24-创建数据库)
  - [2.5 执行数据库迁移与静态文件收集](#25-执行数据库迁移与静态文件收集)
  - [2.6 创建默认管理员（种子数据）](#26-创建默认管理员种子数据)
- [三、前端部署](#三前端部署)
  - [3.1 安装依赖](#31-安装依赖)
  - [3.2 配置 API 地址](#32-配置-api-地址)
  - [3.3 构建生产包](#33-构建生产包)
- [四、Nginx 配置](#四nginx-配置)
- [五、生产环境后台运行（断开 SSH 不终止）](#五生产环境后台运行断开-ssh-不终止)
  - [5.1 Django HTTP 服务 (Gunicorn)](#51-django-http-服务-gunicorn)
  - [5.2 WebSocket 服务 (Daphne)](#52-websocket-服务-daphne)
  - [5.3 启动服务](#53-启动服务)
  - [5.4 常用管理命令](#54-常用管理命令)
- [六、更新部署流程](#六更新部署流程)
- [七、快速部署命令汇总](#七快速部署命令汇总)
- [八、启动项目](#八启动项目)
- [九、端口说明](#九端口说明)
- [十、实验成绩传送流程](#十实验成绩传送流程)
